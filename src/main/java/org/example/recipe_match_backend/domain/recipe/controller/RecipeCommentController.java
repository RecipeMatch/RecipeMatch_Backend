...
@RestController
@RequestMapping("/api/recipes/comment")
...
public class RecipeCommentController {
    ...
    public ResponseEntity<RecipeCommentResponse> createComment(@RequestBody RecipeCommentRequest request) {
        RecipeCommentResponse response = recipeCommentService.createComment(request);
